<div class="modal fade" id="modalImportLanguage" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="<?= adminUrl("language-settings"); ?>" method="post" class="kt-form" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <input type="hidden" name="submit" value="import">

                <div class="modal-header">
                    <h3 class="modal-title"><?= trans("import_language"); ?></h3>
                ...
                <div class="modal-body scroll-y mx-lg-5 my-7">
                    <div class="fv-row mb-6">
                        <label class="fs-5 fw-bold form-label mb-2"><span class="required"><?= trans("json_language_file"); ?></span></label>
