<?php
$templateColor = $templateColor ?: '#4f46e5';
                ...
                <tr>
                    <td align="center" valign="top" style="padding: 40px 0;">
                        ...
                        <table align="center" role="presentation" border="0" cellpadding="0" cellspacing="0" width="600" style="width: 600px; max-width: 600px;" class="mobile-stack">
                            ...
                            <tr>
                                <td align="center" bgcolor="<?= esc($templateColor, 'attr'); ?>" style="background-color: <?= esc($templateColor, 'attr'); ?>; border-top-left-radius: 12px; border-top-right-radius: 12px; padding: 48px 0;">
                            ...
                            <tr>
                                <td align="center" bgcolor="#ffffff" style="background-color: #ffffff; border-bottom-left-radius: 12px; border-bottom-right-radius: 12px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1); border-left: 1px solid #e2e8f0; border-right: 1px solid #e2e8f0; border-bottom: 1px solid #e2e8f0;" class="content-bg">
                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td style="padding: 48px;" class="mobile-padding text-body-content">

                                                <h1 style="margin: 0 0 24px 0; font-family: <?= $fontFamily; ?>; font-size: 28px; line-height: 36px; color: #0f172a; font-weight: 800; text-align: center;">
                                                    <?= esc($title ?? $subject); ?>
                                                </h1>
                                                ...
                                                <?php if (!empty($buttonUrl)): ?>
                                                    <p style="margin: 0; font-size: 11px !important; line-height: 18px !important; color: #94a3b8 !important; word-break: break-all;">
                                                        ...
                                                        <a href="<?= esc($buttonUrl); ?>" style="color: <?= esc($templateColor, 'attr'); ?> !important; text-decoration: underline !important; font-weight: 600; font-size: 12px !important; word-break: break-word; overflow-wrap: anywhere;"><?= esc($buttonUrl); ?></a>
                                                    </p>
                                                <?php endif; ?>
