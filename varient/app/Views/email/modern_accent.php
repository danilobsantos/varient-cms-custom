                            ...
                            <tr>
                                <td align="center" style="border-radius: 24px; overflow: hidden">
                                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            <td bgcolor="#ffffff" style="background-color: #ffffff; border-radius: 24px; box-shadow: 0 10px 40px -10px rgba(0, 0, 0, 0.08); border: 1px solid #e5e7eb; overflow: hidden;" class="content-bg">

                                                <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">

                                                    <tr>
                                                        <td height="6" bgcolor="<?= esc($templateColor, 'attr'); ?>" style="background-color: <?= esc($templateColor, 'attr'); ?>; font-size: 6px; line-height: 6px;">&nbsp;</td>
                                                    </tr>

                                                    <tr>
                                                        <td style="padding: 48px; border-radius: 24px;" class="mobile-padding text-body-content">
                                                                    ...
                                                                    <tr>
                                                                        <td align="center" style="padding-top: 32px; padding-bottom: 24px;">
                                                                            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                                                                <tr>
                                                                                    <td align="center" bgcolor="<?= esc($templateColor, 'attr'); ?>" style="border-radius: 36px;">
                                                                                        <a href="<?= esc($buttonUrl); ?>" target="_blank" style="display: inline-block; padding: 12px 30px; font-family: <?= $fontFamily; ?>; font-size: 16px !important; color: #ffffff !important; text-decoration: none !important; font-weight: 600; border-radius: 36px; background-color: <?= esc($templateColor, 'attr'); ?>; border: 1px solid <?= esc($templateColor, 'attr'); ?>;">
                                                                                            <?= esc($buttonText); ?>
                                                                                        </a>
                                                                                    </td>
                                                                                </tr>
                                                            ...
                                                            <?php if (!empty($requestWarning)): ?>
                                                                <p style="margin: 16px 0 0 0; font-size: 14px !important; line-height: 22px !important; color: #94a3b8 !important; text-align: center;">
                                                    ...
                                                    <tr>
                                                        <td style="padding: 0 48px 40px 48px; text-align: center;" class="mobile-padding">
                                                            ...
                                                            <?php if (!empty($buttonUrl)): ?>
                                                                <p style="margin: 0 0 24px 0; font-family: <?= $fontFamily; ?>; font-size: 13px; line-height: 20px; color: #64748b; text-align: center; font-weight: 500;">
                                                                    ...
                                                                    <a href="<?= esc($buttonUrl); ?>" style="color: <?= esc($templateColor, 'attr'); ?>; text-decoration: none; font-size: 13px !important; word-break: break-word; overflow-wrap: anywhere;"><?= esc($buttonUrl); ?></a>
                                                                </p>
                                                            <?php endif; ?>
