                            ...
                            <div id="postsLoadMoreContent" class="row">
                                ...
                                if (!empty($latestPosts)):
                                    foreach ($latestPosts as $item):
                                        if ($i < $postsPerPage):?>
                                            <?= loadView("post/_post_item_horizontal", ['postItem' => $item, 'showLabel' => true]); ?>
                                        <?php endif;
                                        $i++;
                                    endforeach;
                                endif; ?>
                            ...
                            <?php if (countItems($latestPosts) > $postsPerPage): ?>
                                <div class="search-load-more-container">
                                    <div class="d-flex justify-content-center mt-3 mb-3">
                                        <button class="btn-load-more-posts" data-lang-id="<?= $activeLang->id; ?>" data-type="latest" data-view-type="horizontal">
                                            <span class="btn-text">
